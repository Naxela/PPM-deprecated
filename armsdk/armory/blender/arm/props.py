...
# Armory version
arm_version = '0.5'
arm_commit = '$Id: 39892401f6e56918aa5021e21b860b9f0020786d $'
...
# Armory PPV !!TODO - update=set_PPV_trait
    bpy.types.Object.arm_PPV = BoolProperty(name="Enable Post-process Volume", description="Add the mesh as a post-process volume", default=False)
    #bpy.types. Camera listed
    bpy.types.Object.arm_PPV_transition_time = FloatProperty(name="Transition Duration", description="Transition time in seconds", default=0.0)
    bpy.types.Object.arm_PPV_colorgrading_context = EnumProperty(
        items=[('Global', 'Global', 'Global'),
               ('Shadows', 'Shadows', 'Shadows'),
               ('Midtones', 'Midtones', 'Midtones'),
               ('Highlights', 'Highlights', 'Highlights')
               ],
        name="Colorgrading Context", description="Select the colorgrading submenu", default='Global')
    bpy.types.Object.arm_PPV_colorgrading_global_whitebalance = IntProperty(name="Whitebalance", description="Set the global whiteblance", default=7500, min=1500, max=15000)
    bpy.types.Object.arm_PPV_colorgrading_shadows_max = FloatProperty(name="Shadows Maximum", description="", default=0.0, min=0.0, max=1.0)
    bpy.types.Object.arm_PPV_colorgrading_highlights_min = FloatProperty(name="Highlights Minimum", description="", default=0.0, min=0.0, max=1.0)

    bpy.types.Object.arm_PPV_colorgrading_value_mode = EnumProperty(
        items=[('Uniform', 'Uniform', 'Uniform'),
               ('RGB', 'RGB', 'RGB'),
               ('Colorwheel', 'Colorwheel', 'Colorwheel')
               ],
        name="Value Mode", description="Select the colorgrading value mode", default='Uniform')

        #Global Uniform Values
    bpy.types.Object.arm_PPV_colorgrading_global_saturation = FloatProperty(name="Saturation", description="Global saturation value", default=1.0, min=0.0, max=2.0)
    bpy.types.Object.arm_PPV_colorgrading_global_contrast = FloatProperty(name="Contrast", description="Global contrast value", default=1.0, min=0.0, max=2.0)
    bpy.types.Object.arm_PPV_colorgrading_global_gamma = FloatProperty(name="Gamma", description="Global gamma value", default=1.0, min=0.0, max=2.0)
    bpy.types.Object.arm_PPV_colorgrading_global_gain = FloatProperty(name="Gain", description="Global gain value", default=1.0, min=0.0, max=2.0)
    bpy.types.Object.arm_PPV_colorgrading_global_offset = FloatProperty(name="Offset", description="Global offset value", default=1.0, min=0.0, max=2.0)
    
        #Global RGB Values
    bpy.types.Object.arm_PPV_colorgrading_global_saturation_r = FloatProperty(name="R", description="Global saturation value R", default=1.0, min=0.0, max=2.0)
    bpy.types.Object.arm_PPV_colorgrading_global_contrast_r = FloatProperty(name="R", description="Global contrast value R", default=1.0, min=0.0, max=2.0)
    bpy.types.Object.arm_PPV_colorgrading_global_gamma_r = FloatProperty(name="R", description="Global gamma value R", default=1.0, min=0.0, max=2.0)
    bpy.types.Object.arm_PPV_colorgrading_global_gain_r = FloatProperty(name="R", description="Global gain value R", default=1.0, min=0.0, max=2.0)
    bpy.types.Object.arm_PPV_colorgrading_global_offset_r = FloatProperty(name="R", description="Global offset value R", default=1.0, min=0.0, max=2.0)
    bpy.types.Object.arm_PPV_colorgrading_global_saturation_g = FloatProperty(name="G", description="Global saturation value G", default=1.0, min=0.0, max=2.0)
    bpy.types.Object.arm_PPV_colorgrading_global_contrast_g = FloatProperty(name="G", description="Global contrast value G", default=1.0, min=0.0, max=2.0)
    bpy.types.Object.arm_PPV_colorgrading_global_gamma_g = FloatProperty(name="G", description="Global gamma value G", default=1.0, min=0.0, max=2.0)
    bpy.types.Object.arm_PPV_colorgrading_global_gain_g = FloatProperty(name="G", description="Global gain value G", default=1.0, min=0.0, max=2.0)
    bpy.types.Object.arm_PPV_colorgrading_global_offset_g = FloatProperty(name="G", description="Global offset value G", default=1.0, min=0.0, max=2.0)
    bpy.types.Object.arm_PPV_colorgrading_global_saturation_b = FloatProperty(name="B", description="Global saturation value B", default=1.0, min=0.0, max=2.0)
    bpy.types.Object.arm_PPV_colorgrading_global_contrast_b = FloatProperty(name="B", description="Global contrast value B", default=1.0, min=0.0, max=2.0)
    bpy.types.Object.arm_PPV_colorgrading_global_gamma_b = FloatProperty(name="B", description="Global gamma value B", default=1.0, min=0.0, max=2.0)
    bpy.types.Object.arm_PPV_colorgrading_global_gain_b = FloatProperty(name="B", description="Global gain value B", default=1.0, min=0.0, max=2.0)
    bpy.types.Object.arm_PPV_colorgrading_global_offset_b = FloatProperty(name="B", description="Global offset value B", default=1.0, min=0.0, max=2.0)

        #Global Colorwheel Values
    bpy.types.Object.arm_PPV_colorgrading_global_saturation_wheel = FloatVectorProperty(name="Saturation", size=3, default=[1, 1, 1], subtype='COLOR', min=0, max=2)
    bpy.types.Object.arm_PPV_colorgrading_global_contrast_wheel = FloatVectorProperty(name="Contrast", size=3, default=[1, 1, 1], subtype='COLOR', min=0, max=2)
    bpy.types.Object.arm_PPV_colorgrading_global_gamma_wheel = FloatVectorProperty(name="Gamma", size=3, default=[1, 1, 1], subtype='COLOR', min=0, max=2)
    bpy.types.Object.arm_PPV_colorgrading_global_gain_wheel = FloatVectorProperty(name="Gain", size=3, default=[1, 1, 1], subtype='COLOR', min=0, max=2)
    bpy.types.Object.arm_PPV_colorgrading_global_offset_wheel = FloatVectorProperty(name="Offset", size=3, default=[1, 1, 1], subtype='COLOR', min=0, max=2)

        #Shadow Uniform Values
    bpy.types.Object.arm_PPV_colorgrading_shadows_saturation = FloatProperty(name="Saturation", description="Shadows saturation value", default=1.0, min=0.0, max=2.0)
    bpy.types.Object.arm_PPV_colorgrading_shadows_contrast = FloatProperty(name="Contrast", description="Global contrast value", default=1.0, min=0.0, max=2.0)
    bpy.types.Object.arm_PPV_colorgrading_shadows_gamma = FloatProperty(name="Gamma", description="Global gamma value", default=1.0, min=0.0, max=2.0)
    bpy.types.Object.arm_PPV_colorgrading_shadows_gain = FloatProperty(name="Gain", description="Global gain value", default=1.0, min=0.0, max=2.0)
    bpy.types.Object.arm_PPV_colorgrading_shadows_offset = FloatProperty(name="Offset", description="Global offset value", default=1.0, min=0.0, max=2.0)

        #Shadow RGB Values
    bpy.types.Object.arm_PPV_colorgrading_shadows_saturation_r = FloatProperty(name="R", description="Shadows saturation value R", default=1.0, min=0.0, max=2.0)
    bpy.types.Object.arm_PPV_colorgrading_shadows_contrast_r = FloatProperty(name="R", description="Global contrast value R", default=1.0, min=0.0, max=2.0)
    bpy.types.Object.arm_PPV_colorgrading_shadows_gamma_r = FloatProperty(name="R", description="Global gamma value R", default=1.0, min=0.0, max=2.0)
    bpy.types.Object.arm_PPV_colorgrading_shadows_gain_r = FloatProperty(name="R", description="Global gain value R", default=1.0, min=0.0, max=2.0)
    bpy.types.Object.arm_PPV_colorgrading_shadows_offset_r = FloatProperty(name="R", description="Global offset value R", default=1.0, min=0.0, max=2.0)
    bpy.types.Object.arm_PPV_colorgrading_shadows_saturation_g = FloatProperty(name="G", description="Shadows saturation value G", default=1.0, min=0.0, max=2.0)
    bpy.types.Object.arm_PPV_colorgrading_shadows_contrast_g = FloatProperty(name="G", description="Global contrast value G", default=1.0, min=0.0, max=2.0)
    bpy.types.Object.arm_PPV_colorgrading_shadows_gamma_g = FloatProperty(name="G", description="Global gamma value G", default=1.0, min=0.0, max=2.0)
    bpy.types.Object.arm_PPV_colorgrading_shadows_gain_g = FloatProperty(name="G", description="Global gain value G", default=1.0, min=0.0, max=2.0)
    bpy.types.Object.arm_PPV_colorgrading_shadows_offset_g = FloatProperty(name="G", description="Global offset value G", default=1.0, min=0.0, max=2.0)
    bpy.types.Object.arm_PPV_colorgrading_shadows_saturation_b = FloatProperty(name="B", description="Shadows saturation value B", default=1.0, min=0.0, max=2.0)
    bpy.types.Object.arm_PPV_colorgrading_shadows_contrast_b = FloatProperty(name="B", description="Global contrast value B", default=1.0, min=0.0, max=2.0)
    bpy.types.Object.arm_PPV_colorgrading_shadows_gamma_b = FloatProperty(name="B", description="Global gamma value B", default=1.0, min=0.0, max=2.0)
    bpy.types.Object.arm_PPV_colorgrading_shadows_gain_b = FloatProperty(name="B", description="Global gain value B", default=1.0, min=0.0, max=2.0)
    bpy.types.Object.arm_PPV_colorgrading_shadows_offset_b = FloatProperty(name="B", description="Global offset value B", default=1.0, min=0.0, max=2.0)
        
        #Shadow Colorwheel Values
    bpy.types.Object.arm_PPV_colorgrading_shadows_saturation_wheel = FloatVectorProperty(name="Saturation", size=3, default=[1, 1, 1], subtype='COLOR', min=0, max=2)
    bpy.types.Object.arm_PPV_colorgrading_shadows_contrast_wheel = FloatVectorProperty(name="Contrast", size=3, default=[1, 1, 1], subtype='COLOR', min=0, max=2)
    bpy.types.Object.arm_PPV_colorgrading_shadows_gamma_wheel = FloatVectorProperty(name="Gamma", size=3, default=[1, 1, 1], subtype='COLOR', min=0, max=2)
    bpy.types.Object.arm_PPV_colorgrading_shadows_gain_wheel = FloatVectorProperty(name="Gain", size=3, default=[1, 1, 1], subtype='COLOR', min=0, max=2)
    bpy.types.Object.arm_PPV_colorgrading_shadows_offset_wheel = FloatVectorProperty(name="Offset", size=3, default=[1, 1, 1], subtype='COLOR', min=0, max=2)

        #Midtones Uniform Values
    bpy.types.Object.arm_PPV_colorgrading_midtones_saturation = FloatProperty(name="Saturation", description="Shadows saturation value", default=1.0, min=0.0, max=2.0)
    bpy.types.Object.arm_PPV_colorgrading_midtones_contrast = FloatProperty(name="Contrast", description="Global contrast value", default=1.0, min=0.0, max=2.0)
    bpy.types.Object.arm_PPV_colorgrading_midtones_gamma = FloatProperty(name="Gamma", description="Global gamma value", default=1.0, min=0.0, max=2.0)
    bpy.types.Object.arm_PPV_colorgrading_midtones_gain = FloatProperty(name="Gain", description="Global gain value", default=1.0, min=0.0, max=2.0)
    bpy.types.Object.arm_PPV_colorgrading_midtones_offset = FloatProperty(name="Offset", description="Global offset value", default=1.0, min=0.0, max=2.0)
        #Midtones RGB Values
    bpy.types.Object.arm_PPV_colorgrading_midtones_saturation_r = FloatProperty(name="R", description="Shadows saturation value R", default=1.0, min=0.0, max=2.0)
    bpy.types.Object.arm_PPV_colorgrading_midtones_contrast_r = FloatProperty(name="R", description="Global contrast value R", default=1.0, min=0.0, max=2.0)
    bpy.types.Object.arm_PPV_colorgrading_midtones_gamma_r = FloatProperty(name="R", description="Global gamma value R", default=1.0, min=0.0, max=2.0)
    bpy.types.Object.arm_PPV_colorgrading_midtones_gain_r = FloatProperty(name="R", description="Global gain value R", default=1.0, min=0.0, max=2.0)
    bpy.types.Object.arm_PPV_colorgrading_midtones_offset_r = FloatProperty(name="R", description="Global offset value R", default=1.0, min=0.0, max=2.0)
    bpy.types.Object.arm_PPV_colorgrading_midtones_saturation_g = FloatProperty(name="G", description="Shadows saturation value G", default=1.0, min=0.0, max=2.0)
    bpy.types.Object.arm_PPV_colorgrading_midtones_contrast_g = FloatProperty(name="G", description="Global contrast value G", default=1.0, min=0.0, max=2.0)
    bpy.types.Object.arm_PPV_colorgrading_midtones_gamma_g = FloatProperty(name="G", description="Global gamma value G", default=1.0, min=0.0, max=2.0)
    bpy.types.Object.arm_PPV_colorgrading_midtones_gain_g = FloatProperty(name="G", description="Global gain value G", default=1.0, min=0.0, max=2.0)
    bpy.types.Object.arm_PPV_colorgrading_midtones_offset_g = FloatProperty(name="G", description="Global offset value B", default=1.0, min=0.0, max=2.0)
    bpy.types.Object.arm_PPV_colorgrading_midtones_saturation_b = FloatProperty(name="B", description="Shadows saturation value B", default=1.0, min=0.0, max=2.0)
    bpy.types.Object.arm_PPV_colorgrading_midtones_contrast_b = FloatProperty(name="B", description="Global contrast value B", default=1.0, min=0.0, max=2.0)
    bpy.types.Object.arm_PPV_colorgrading_midtones_gamma_b = FloatProperty(name="B", description="Global gamma value B", default=1.0, min=0.0, max=2.0)
    bpy.types.Object.arm_PPV_colorgrading_midtones_gain_b = FloatProperty(name="B", description="Global gain value B", default=1.0, min=0.0, max=2.0)
    bpy.types.Object.arm_PPV_colorgrading_midtones_offset_b = FloatProperty(name="B", description="Global offset value B", default=1.0, min=0.0, max=2.0)
        #Midtones Colorwheel Values
    bpy.types.Object.arm_PPV_colorgrading_midtones_saturation_wheel = FloatVectorProperty(name="Saturation", size=3, default=[1, 1, 1], subtype='COLOR', min=0, max=2)
    bpy.types.Object.arm_PPV_colorgrading_midtones_contrast_wheel = FloatVectorProperty(name="Contrast", size=3, default=[1, 1, 1], subtype='COLOR', min=0, max=2)
    bpy.types.Object.arm_PPV_colorgrading_midtones_gamma_wheel = FloatVectorProperty(name="Gamma", size=3, default=[1, 1, 1], subtype='COLOR', min=0, max=2)
    bpy.types.Object.arm_PPV_colorgrading_midtones_gain_wheel = FloatVectorProperty(name="Gain", size=3, default=[1, 1, 1], subtype='COLOR', min=0, max=2)
    bpy.types.Object.arm_PPV_colorgrading_midtones_offset_wheel = FloatVectorProperty(name="Offset", size=3, default=[1, 1, 1], subtype='COLOR', min=0, max=2)

        #Highlights Uniform Values
    bpy.types.Object.arm_PPV_colorgrading_highlights_saturation = FloatProperty(name="Saturation", description="Shadows saturation value", default=1.0, min=0.0, max=2.0)
    bpy.types.Object.arm_PPV_colorgrading_highlights_contrast = FloatProperty(name="Contrast", description="Global contrast value", default=1.0, min=0.0, max=2.0)
    bpy.types.Object.arm_PPV_colorgrading_highlights_gamma = FloatProperty(name="Gamma", description="Global gamma value", default=1.0, min=0.0, max=2.0)
    bpy.types.Object.arm_PPV_colorgrading_highlights_gain = FloatProperty(name="Gain", description="Global gain value", default=1.0, min=0.0, max=2.0)
    bpy.types.Object.arm_PPV_colorgrading_highlights_offset = FloatProperty(name="Offset", description="Global offset value", default=1.0, min=0.0, max=2.0)

        #Highlights RGB Values
    bpy.types.Object.arm_PPV_colorgrading_highlights_saturation_r = FloatProperty(name="R", description="Shadows saturation value R", default=1.0, min=0.0, max=2.0)
    bpy.types.Object.arm_PPV_colorgrading_highlights_contrast_r = FloatProperty(name="R", description="Global contrast value R", default=1.0, min=0.0, max=2.0)
    bpy.types.Object.arm_PPV_colorgrading_highlights_gamma_r = FloatProperty(name="R", description="Global gamma value R", default=1.0, min=0.0, max=2.0)
    bpy.types.Object.arm_PPV_colorgrading_highlights_gain_r = FloatProperty(name="R", description="Global gain value R", default=1.0, min=0.0, max=2.0)
    bpy.types.Object.arm_PPV_colorgrading_highlights_offset_r = FloatProperty(name="R", description="Global offset value R", default=1.0, min=0.0, max=2.0)
    bpy.types.Object.arm_PPV_colorgrading_highlights_saturation_g = FloatProperty(name="G", description="Shadows saturation value G", default=1.0, min=0.0, max=2.0)
    bpy.types.Object.arm_PPV_colorgrading_highlights_contrast_g = FloatProperty(name="G", description="Global contrast value G", default=1.0, min=0.0, max=2.0)
    bpy.types.Object.arm_PPV_colorgrading_highlights_gamma_g = FloatProperty(name="G", description="Global gamma value G", default=1.0, min=0.0, max=2.0)
    bpy.types.Object.arm_PPV_colorgrading_highlights_gain_g = FloatProperty(name="G", description="Global gain value G", default=1.0, min=0.0, max=2.0)
    bpy.types.Object.arm_PPV_colorgrading_highlights_offset_g = FloatProperty(name="G", description="Global offset value G", default=1.0, min=0.0, max=2.0)
    bpy.types.Object.arm_PPV_colorgrading_highlights_saturation_b = FloatProperty(name="B", description="Shadows saturation value B", default=1.0, min=0.0, max=2.0)
    bpy.types.Object.arm_PPV_colorgrading_highlights_contrast_b = FloatProperty(name="B", description="Global contrast value B", default=1.0, min=0.0, max=2.0)
    bpy.types.Object.arm_PPV_colorgrading_highlights_gamma_b = FloatProperty(name="B", description="Global gamma value B", default=1.0, min=0.0, max=2.0)
    bpy.types.Object.arm_PPV_colorgrading_highlights_gain_b = FloatProperty(name="B", description="Global gain value B", default=1.0, min=0.0, max=2.0)
    bpy.types.Object.arm_PPV_colorgrading_highlights_offset_b = FloatProperty(name="B", description="Global offset value B", default=1.0, min=0.0, max=2.0)

        #Highlights Colorwheel Values
    bpy.types.Object.arm_PPV_colorgrading_highlights_saturation_wheel = FloatVectorProperty(name="Saturation", size=3, default=[1, 1, 1], subtype='COLOR', min=0, max=2)
    bpy.types.Object.arm_PPV_colorgrading_highlights_contrast_wheel = FloatVectorProperty(name="Contrast", size=3, default=[1, 1, 1], subtype='COLOR', min=0, max=2)
    bpy.types.Object.arm_PPV_colorgrading_highlights_gamma_wheel = FloatVectorProperty(name="Gamma", size=3, default=[1, 1, 1], subtype='COLOR', min=0, max=2)
    bpy.types.Object.arm_PPV_colorgrading_highlights_gain_wheel = FloatVectorProperty(name="Gain", size=3, default=[1, 1, 1], subtype='COLOR', min=0, max=2)
    bpy.types.Object.arm_PPV_colorgrading_highlights_offset_wheel = FloatVectorProperty(name="Offset", size=3, default=[1, 1, 1], subtype='COLOR', min=0, max=2)

        #Post-Process Overrides
    bpy.types.Object.arm_PPV_bloom_threshold = FloatProperty(name="Threshold", default=1.0, update=assets.invalidate_shader_cache)
    bpy.types.Object.arm_PPV_bloom_strength = FloatProperty(name="Strength", default=3.5, update=assets.invalidate_shader_cache)
    bpy.types.Object.arm_PPV_bloom_radius = FloatProperty(name="Radius", default=3.0, update=assets.invalidate_shader_cache)
    bpy.types.Object.arm_PPV_chromatic_aberration_strength = FloatProperty(name="Strength", description="Set the strength of the chromatic aberration", default=0.04, min=0.0, max=1.0)
    bpy.types.Object.arm_PPV_chromatic_aberration_samples = EnumProperty(
        items=[('Low', 'Low', 'Low'),
               ('Medium', 'Medium', 'Medium'),
               ('High', 'High', 'High')
               ],
        name="Quality", description="Set the quality of the chromatic aberration", default='Low')
    bpy.types.Object.arm_PPV_film_grain_strength = FloatProperty(name="Film Grain", description="Set the strength of the film grain", default=2.0, min=0.0, max=4.0)
    bpy.types.Object.arm_PPV_SSR_step = FloatProperty(name="Step", default=0.04)
    bpy.types.Object.arm_PPV_SSR_step_min = FloatProperty(name="Step Min", default=0.05)
    bpy.types.Object.arm_PPV_SSR_search = FloatProperty(name="Search", default=5.0)
    bpy.types.Object.arm_PPV_SSR_falloff = FloatProperty(name="Falloff", default=5.0)
    bpy.types.Object.arm_PPV_SSR_jitter = FloatProperty(name="Jitter", default=0.6)
    bpy.types.Object.arm_PPV_vignette = FloatProperty(name="Vignette", description="Vignette Strength", default=1.0, min=0.0, max=2.0)
    # For speakers
