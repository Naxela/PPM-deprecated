...
class ColorgradingGlobalNode(Node, ArmLogicTreeNode):
    '''Colorgrading Highlight node'''
    bl_idname = 'LNColorgradingHighlightNode'
    bl_label = 'Colorgrading Highlight'
    bl_icon = 'QUESTION'
    ...
    filepath : StringProperty(name="Preset File", description="PPV colorgrading preset file", default="", subtype="FILE_PATH", update=set_data)
...
add_node(ColorgradingGlobalNode, category='PPV')